        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            <div class="group bg-white rounded-2xl shadow hover:shadow-xl transition overflow-hidden">
                ...
                <div class="p-6">
                    ...
                    <p class="text-orange-500 font-semibold">¥1,000</p>
                </div>
            </div>
            ...
            <div class="group bg-white rounded-2xl shadow hover:shadow-xl transition overflow-hidden">
                ...
                <div class="p-6">
                    ...
                    <p class="text-orange-500 font-semibold">¥1,200</p>
                </div>
            </div>
            ...
            <div class="group bg-white rounded-2xl shadow hover:shadow-xl transition overflow-hidden">
                ...
                <div class="p-6">
                    ...
                    <p class="text-orange-500 font-semibold">¥1,500</p>
                </div>
            </div>
